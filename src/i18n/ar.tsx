const ar = {
  ...
  auth: {
    ...
    verifyEmail: {
      ...
      message: "لحظة فقط ، يتم التحقق من بريدك الإلكتروني ...",
    },
  },
  ...
  tenant: {
    ...
    invitation: {
      ...
      acceptWrongEmail: "اقبل الدعوة بهذا البريد الإلكتروني",
    },
  ...
  auditLog: {
    ...
    entityNamesHint: "افصل بين الكيانات المتعددة باستخدام حرف الفاصلة.",
    fields: {
      id: "Id",
  ...
  validation: {
    mixed: {
      ...
      required: "مطلوب $ {path}",
      oneOf: "يجب أن يكون $ {path} أحد القيم التالية: $ {values}",
      notOneOf: "يجب ألا يكون $ {path} من القيم التالية: $ {values}",
      notType: ({ path, type, value, originalValue }) => {
        return `${path} must be a ${type}`;
      },
    },
    string: {
      length: "يجب أن يتألف $ {path} من $ {length} حرفًا بالضبط",
    ...
    number: {
      ...
      notEqual: "يجب ألا يكون $ {path} مساويًا لـ $ {notEqual}",
