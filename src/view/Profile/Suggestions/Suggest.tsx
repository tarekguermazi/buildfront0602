        ...
        <div className='mainContent'>
          ...
          <form onSubmit={handleSubmit(handleFormSubmission)}>
            ...
            <section className='description'>
              ...
              adipisicing elit. Omnis voluptates deserunt optio maxime ad
              vero voluptatum quibusdam laborum nulla architecto recusandae
              nam, nihil quos. Rerum incidunt tenetur accusantium rem
              voluptates, voluptas iste nihil, ipsam
            </section>
            ...
            <section className='contentCategory'>
              ...
              <select name='categories' ref={register}>
                ...
                <option value='article scientifique'>
                  article scientifique
                </option>
                <option value='article journalistique'>
                  article journalistique
                </option>
                <option value='rapport'>rapport</option>
                <option value='entretien'>entretien</option>
                <option value='données numériques'>
                  données numériques
                </option>
